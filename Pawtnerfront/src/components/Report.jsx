...
import curiouscat from "../assets/curiouscat.gif";
...
export default function Report() {
  ...
  function handleShowMapOrForm() {
    if (!user)
      return (
        <p>
          Please log in to submit a report <br /> <br />
          <img src={curiouscat} alt="curiouscat" />
        </p>
      );
    if (showMap) {
      return (
          ...
          <div className="form-colums">
            ...
            <div className="form-right">
              ...
              <div className="checkbox-group">
                ...
                />
                <label htmlFor="terms">
                  I agree to include my email for contact
                </label>
                <br />
                <br />
              </div>
  ...
  return (
    <div className="page-container">
      ...
      <div className="sidebar">
        <p>
          Please select the place you want to report and click on "Report Now!"
        </p>
