...
export default function Text(){
    ...
    return(
        <div className="text-container">
           ...
           <p><ul>
                <li>Report animal abuse with detailed descriptions, photos, and precise location data, enabling authorities and organizations to respond effectively.</li>

                <li>Report lost or found animals, sharing descriptions and images to facilitate reunions or rescues.</li>

                <li>Access an interactive map that displays real-time reports, fostering community engagement and collaboration.</li>
            </ul>
            </p> 
